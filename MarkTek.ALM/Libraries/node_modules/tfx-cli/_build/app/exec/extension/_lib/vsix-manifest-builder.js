...
var VsixManifestBuilder = (function (_super) {
    ...
    VsixManifestBuilder.prototype.genContentTypesXml = function (builders) {
        ...
        if (windows) {
            ...
            var uniqueExtensions = _.unique(Object.keys(this.files).map(function (f) {
            ...
            contentTypePromise = Q.all(contentTypePromises_1);
        }
        else {
            ...
            contentTypePromise = Q.all(contentTypePromises_2).then(function () {
