...
var ExtensionShare = (function (_super) {
    ...
    ExtensionShare.prototype.exec = function () {
        var _this = this;
        var galleryApi = this.webApi.getQGalleryApi(this.webApi.serverUrl);
        return this.commandArgs.vsix.val(true).then(function (vsixPath) {
            ...
            if (vsixPath !== null) {
                ...
                extInfoPromise = Q.all([_this.commandArgs.publisher.val(), _this.commandArgs.extensionId.val()]).spread(function (publisher, extension) {
            ...
            return extInfoPromise.then(function (extInfo) {
                return _this.commandArgs.unshareWith.val().then(function (unshareWith) {
                    ...
                    return Q.all(sharePromises).then(function () { return unshareWith; });
                });
            });
        });
    };
